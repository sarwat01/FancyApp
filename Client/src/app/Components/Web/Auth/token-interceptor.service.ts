...
@Injectable()
export class TokenInterceptorFancy implements HttpInterceptor {
  ...
  constructor(
    public authService: AuthServiceFancy,
    ...
    return next.handle(request).pipe(
      catchError((error) => {
        ...
        if (
          ...
          this.toastService.warning('تکایە دڵنیابەرەوە لە کۆد و پاسۆردەکەت');
